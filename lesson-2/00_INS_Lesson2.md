# Instructor File - Lesson 2

## Order

1. Go over Conceptual Overview
2. Show examples of multiple git repositories locally; but also on GitHub/DevOps.
3. Go over Basic Workflow in detail
4. Warn against creating a git repo downstream from another git repo (there are use-cases for submodules, but we won't be covering these).
5. Start example:
	+ Write a book: "Alice in Wonderland" (really first chapter of book)
		...
		* Do one or two commits, show the log
...
===
[Alice's Adventures In Wonderland by Lewis Carroll](https://www.gutenberg.org/files/11/11-h/11-h.htm)
