# Instructor File - Lesson 4

## Order

1. Go over sections
	+ When to merge
	+ Three major merge strategies
2. Start example 1:
	+ Current state: AIW has two branches: `new-name` and `main`
	+ Show an example of a FF merge:
		* Create a new branch `characters`
...
5. Example 3: pseudo conflict (might expect a conflict, but it's really not - pointers get updated):
   + Merge `new-name` and `main`
6. Example 4: Real conflict
