...
???
1. Go over Azure DevOps. Training for now; as well as IAE specific one.
2. Start example:
 	+ Move the AIW repo to Azure DevOps (existing local ==> cloud) name it `salem-aiw`. Encourage others to upload theirs, create their repos
